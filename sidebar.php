            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="index.php" aria-expanded="false"><em class="fa fa-window-maximize"></em>Dashboard</a>
                        </li>
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Teacher Management</span></a>
                            ...
                            <?php if (isset($useroles) && in_array("add_teacher", $useroles)) { echo '<li><a href="add_teacher.php">Add Teacher</a></li>'; } ?>
                    ...
                    <?php } 
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><em class="fa fa-users"></em><span class="hide-menu">Student Management</span></a>
                            <ul aria-expanded="false" class="collapse">
